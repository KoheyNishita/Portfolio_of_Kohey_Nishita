...
$site_top = "https://portfolio-of-kohey-nishita.herokuapp.com/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "5024kohy.nishi@gmail.com";
...
?>
	...
	<body>
		<div class="confirm-container">
			<h3><span class="color-kariyasu">送</span>信完了</h3>
			<?php if ($empty_flag == 1) { ?>
...
<?php } else { ?>
	...
	<a href="<?php echo $site_top; ?>">
		<div class="btn btn-primary btn-outline-primary">トップへ戻る</div>
	</a>
	</body>
...
<?php
	...
	<div align="center">
		<h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
		<div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()" class="btn btn-primary btn-outline-primary">
	</div>
<?php
			} else {
